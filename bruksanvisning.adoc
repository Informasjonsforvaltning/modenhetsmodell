...
**	https://data.norge.no/specification/dcat-ap-no[DCAT-AP-NO  &#x29C9;, window="_blank", role="ext-link"] er p.t. en anbefalt forvaltningsstandard  for beskrivelse av datasett, datatjenester og datakataloger.   
